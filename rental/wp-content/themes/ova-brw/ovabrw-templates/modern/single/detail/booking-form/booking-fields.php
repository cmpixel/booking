<?php if ( ! defined( 'ABSPATH' ) ) exit();
	...
	if ( $startdate_perido_time ) $class_pickup_date .= ' '.$startdate_perido_time;
...
<?php if ( $rental_type === 'day' || $rental_type === 'hour' || $rental_type === 'mixed' ): ?>
	...
	<?php if ( $show_pickoff_loc ): ?>
		<div class="rental_item">
			...
			<?php
				if ( ! empty( $st_pickup_loc ) && ! empty( $st_dropoff_loc ) ) {
					echo ovabrw_get_setup_locations_html( 'ovabrw_pickoff_loc', 'required', $pickoff_loc, $product_id, 'dropoff' );
				} else {
	...
	<div class="rental_item">
		<label>
			<?php echo esc_html( ovabrw_get_label_pickup_date( $product_id ) ); ?>
		</label>
		<div class="error_item">
			<label>
		...
		<input 
			...
			class="required ovabrw_datetimepicker ovabrw_start_date<?php echo esc_attr( $class_pickup_date ); ?>" 
	...
	<?php if ( $show_pickoff_date ): ?>
		<div class="rental_item">
			<label>
				<?php echo esc_html( ovabrw_get_label_pickoff_date( $product_id ) ); ?>
			</label>
			<div class="error_item">
				<label>
					<?php esc_html_e( 'This field is required', 'ova-brw' ); ?>
...
?>
	...
	<!-- End Taxi -->
<?php endif; ?>
<?php if ( $show_quantity === 'yes' ): $stock_qty = ovabrw_get_total_stock( $product_id ); ?>
	<div class="rental_item">
