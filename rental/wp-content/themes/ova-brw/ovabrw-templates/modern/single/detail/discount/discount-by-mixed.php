...
<?php if ( ! empty( $discount_min ) && ! empty( $discount_min ) ): ?>
	<div class="ovabrw-product-discount">
		...
		<?php if ( ! empty( $discount_type ) && is_array( $discount_type ) && in_array( 'days' , $discount_type ) ): ?>
			<table class="ovabrw-table">
				...
				<tbody>
					...
					?>
						<?php if ( $type === 'days' && $min != '' && $max != '' && $price != '' ): ?>
							<tr>
								<td>
		...
		<?php endif; ?>
		<?php if ( ! empty( $discount_type ) && is_array( $discount_type ) && in_array( 'hours' , $discount_type ) ): ?>
			<table class="ovabrw-table">
				<thead>
					<tr>
