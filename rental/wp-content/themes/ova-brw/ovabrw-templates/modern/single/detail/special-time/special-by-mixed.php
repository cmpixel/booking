<?php if ( ! defined( 'ABSPATH' ) ) exit();
	...
	$special_price_day 	= get_post_meta( $product_id, 'ovabrw_rt_price', true );
	$special_price_hour = get_post_meta( $product_id, 'ovabrw_rt_price_hour', true );
?>
<?php if ( ( ! empty( $special_price_day ) && is_array( $special_price_day ) ) || ( ! empty( $special_price_hour ) && is_array( $special_price_hour ) ) ):
...
?>
	<div class="ovabrw-product-special-time">
		...
		<?php if ( ! empty( $special_price_day ) && is_array( $special_price_day ) ): ?>
													...
													<?php if ( $dsc_price ): ?>
														<table class="ovabrw-table">
															...
															<tbody>
																...
																?>
																	<?php if ( $dsc_v_type === 'days' && $dsc_v_min != '' && $dsc_v_max != '' && $dsc_v_price != '' ): ?>
																		<tr>
																			<td>
		...
		<?php if ( ! empty( $special_price_hour ) && is_array( $special_price_hour ) ): ?>
			<table class="ovabrw-table">
				<thead>
					<tr>
						<th><?php esc_html_e( 'Start Date', 'ova-brw' ); ?></th>
