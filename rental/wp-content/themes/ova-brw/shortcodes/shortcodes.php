...
function ovabrw_search( $atts = array(), $content = null ) {
    ...
    if ( $column == '' ) {
        $column = ovabrw_get_setting( get_option( 'ova_brw_search_column', 'one-column' ) );
    }
    if ( $timepicker == '' ) {
        $timepicker = 'false';
    }
    if ( $show_name_product == '' ) {
        $show_name_product = ovabrw_get_setting( get_option( 'ova_brw_search_show_name_product', 'yes' ) );
    }
    if ( $show_attribute == '' ) {
        $show_attribute = ovabrw_get_setting( get_option( 'ova_brw_search_show_attribute', 'yes' ) );
    }
    if ( $show_tag_product == '' ) {
        $show_tag_product = ovabrw_get_setting( get_option( 'ova_brw_search_show_tag_product', 'yes' ) );
    }
    if ( $show_pickup_loc == '' ) {
        $show_pickup_loc = ovabrw_get_setting( get_option( 'ova_brw_search_show_pick_up_location', 'yes' ) );
    }
    if ( $show_dropoff_loc == '' ) {
        $show_dropoff_loc = ovabrw_get_setting( get_option( 'ova_brw_search_show_drop_off_location', 'yes' ) );
    }
    if ( $show_pickup_date == '' ) {
        $show_pickup_date = ovabrw_get_setting( get_option( 'ova_brw_search_show_pick_up_date', 'yes' ) );
    }
    if ( $show_dropoff_date == '' ) {
        $show_dropoff_date = ovabrw_get_setting( get_option( 'ova_brw_search_show_drop_off_date', 'yes' ) );
    }
    if ( $show_cat == '' ) {
        $show_cat = ovabrw_get_setting( get_option( 'ova_brw_search_show_category', 'yes' ) );
    }
    if ( $show_tax == '' ) {
        $show_tax = ovabrw_get_setting( get_option( 'ova_brw_search_show_taxonomy', 'yes' ) );
    }
    ...
    if ( $hide_taxonomies_slug == '' ) {
        $hide_taxonomies_slug = ovabrw_get_setting( get_option( 'ova_brw_search_hide_taxonomy_slug', '' ) );
    }
    if ( $taxonomies_slug_required == '' ) {
        $taxonomies_slug_required = ovabrw_get_setting( get_option( 'ova_brw_search_require_taxonomy_slug', '' ) );
    }
            ...
            if ( taxonomy_exists( wc_attribute_taxonomy_name( $tax->attribute_name ) ) ):
                ...
                $html_select_value_attribute .= '<div class="s_field '.$column.' ovabrw-value-attribute '.$class_acctive.'" id="'.$tax->attribute_name.'">';
                    $html_select_value_attribute .= '<div class="content">';
                        ...
                        $html_select_value_attribute .= '<div class="wrap-error"></div>';
...
// Product List
add_shortcode( 'ovabrw_products', 'ovabrw_list_products_shortcode' );
function ovabrw_list_products_shortcode( $atts ) {
    $atts = extract( shortcode_atts(
        array(
            'class'             => '',
            'posts_per_page'    => '',
...
// Product Images
add_shortcode( 'ovabrw_product_images', 'ovabrw_product_images_shortcode' );
if ( ! function_exists( 'ovabrw_product_images_shortcode' ) ) {
    function ovabrw_product_images_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Unavailable
add_shortcode( 'ovabrw_product_unavailable', 'ovabrw_product_unavailable_shortcode' );
if ( ! function_exists( 'ovabrw_product_unavailable_shortcode' ) ) {
    function ovabrw_product_unavailable_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Title
add_shortcode( 'ovabrw_product_title', 'ovabrw_product_title_shortcode' );
if ( ! function_exists( 'ovabrw_product_title_shortcode' ) ) {
    function ovabrw_product_title_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Price
add_shortcode( 'ovabrw_product_price', 'ovabrw_product_price_shortcode' );
if ( ! function_exists( 'ovabrw_product_price_shortcode' ) ) {
    function ovabrw_product_price_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Review
add_shortcode( 'ovabrw_product_review', 'ovabrw_product_review_shortcode' );
if ( ! function_exists( 'ovabrw_product_review_shortcode' ) ) {
    function ovabrw_product_review_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Taxonomy
add_shortcode( 'ovabrw_product_taxonomy', 'ovabrw_product_taxonomy_shortcode' );
if ( ! function_exists( 'ovabrw_product_taxonomy_shortcode' ) ) {
    function ovabrw_product_taxonomy_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Meta
add_shortcode( 'ovabrw_product_meta', 'ovabrw_product_meta_shortcode' );
if ( ! function_exists( 'ovabrw_product_meta_shortcode' ) ) {
    function ovabrw_product_meta_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Features
add_shortcode( 'ovabrw_product_features', 'ovabrw_product_features_shortcode' );
if ( ! function_exists( 'ovabrw_product_features_shortcode' ) ) {
    function ovabrw_product_features_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
add_shortcode( 'ovabrw_product_short_description', 'ovabrw_product_short_description_shortcode' );
if ( ! function_exists( 'ovabrw_product_short_description_shortcode' ) ) {
    function ovabrw_product_short_description_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Tabs
add_shortcode( 'ovabrw_product_tabs', 'ovabrw_product_tabs_shortcode' );
if ( ! function_exists( 'ovabrw_product_tabs_shortcode' ) ) {
    function ovabrw_product_tabs_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
...
// Product Related
add_shortcode( 'ovabrw_product_related', 'ovabrw_product_related_shortcode' );
if ( ! function_exists( 'ovabrw_product_related_shortcode' ) ) {
    function ovabrw_product_related_shortcode( $atts ) {
        $atts = extract( shortcode_atts(
            array(
                'id'    => '',
                'class' => ''
