		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'.woocommerce {{WRAPPER}} .woocommerce-product-details__short-description, {{WRAPPER}} .ovabrw-product-short-description' => 'color: {{VALUE}};',
					],
				]
			);
	...
	protected function render() {
		...
		if ( $template === 'modern' ): ?>
			<div class="ovabrw-modern-product">
				<?php ovabrw_get_template( 'modern/single/detail/ovabrw-product-short-description.php' ); ?>
			</div>
		<?php endif;?>
