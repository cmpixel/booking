...
add_action( 'ovabrw_modern_product_left', 'ovabrw_modern_product_is_featured', 10 );
...
add_action( 'ovabrw-modern-after-product', 'woocommerce_output_product_data_tabs', 10 );
add_action( 'ovabrw-modern-after-product', 'ovabrw_modern_product_related', 20 );
// End