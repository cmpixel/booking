...
if( !class_exists('Qomfort_Metaboxes') ){
    
    class Qomfort_Metaboxes {
        ...
        function add(){
            ...
            add_meta_box(
                ...
                apply_filters( 'qomfort_set_header_version' ,array( 'post', 'page' ) )                  // Post type
            );
        ...
        function general_setting( $post ) {
            ...
            $list_header = apply_filters( 'qomfort_list_header', array() ) != '' ? array_merge( array( 'global' => 'Global' ), apply_filters( 'qomfort_list_header', array() ) ) : array( 'global' => 'Global' );
            ?>
            ...
            $list_footer = apply_filters( 'qomfort_list_footer', array() ) != '' ? array_merge( array( 'global' => 'Global' ), apply_filters( 'qomfort_list_footer', array() ) ) : array( 'global' => 'Global' );
            ?>
            ...
            $layouts = apply_filters( 'qomfort_define_layout', array() ) != '' ? array_merge( array( 'global' => 'Global' ), apply_filters( 'qomfort_define_layout', array() ) ) : array( 'global' => 'Global' );
            ?>
            ...
            $wide_site = apply_filters( 'qomfort_define_wide_boxed', array() ) != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters( 'qomfort_define_wide_boxed', array() ) ) : array( 'global' => 'Global' );
            ?>
        ...
        function get_all_font() {
            $fontFile = QOMFORT_URI . '/customize/custom-control/api/google-fonts-alphabetical.json';
