        ...
        switch( $section ) {
            ...
            case 'booking_form':
                $settings = array(
                    ...
                    array(
                        'name'  => esc_html__( 'Show Check-in Date', 'ova-brw' ),
                        'type'  => 'select',
                        'class' => ' ',
                        'options' => [
                            'yes'   => esc_html__( 'Yes', 'ova-brw' ),
            ...
            case 'request_booking_form':
                ...
                $settings = array(
                    ...
                    array(
                        ...
                        'default' => 'yes',
                        'id'    => 'ova_brw_request_booking_form_show_dropoff_date'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'textarea',
                        'desc' => esc_html__( 'Use tags to generate email template. For example: You have hired a room: [ovabrw_vehicle_name] at [ovabrw_order_pickup_date] to [ovabrw_order_dropoff_date]. [ovabrw_order_details]', 'ova-brw' ),
                        'default' => esc_html__( 'You have hired a room: [ovabrw_vehicle_name] at [ovabrw_order_pickup_date] to [ovabrw_order_dropoff_date]. [ovabrw_order_details]', 'ova-brw' ),
            ...
            case 'search_setting':
                $settings = array(
                    ...
                    array(
                        'name'  => esc_html__( 'Require Check-in Date', 'ova-brw' ),
                        'type'  => 'select',
                        'class' => ' ',
                        'default' => 'no',
                        'options' => [
                    ...
                    array(
                        'name'  => esc_html__( 'Require Check-out Date', 'ova-brw' ),
                        'type'  => 'select',
                        'class' => ' ',
                        'default' => 'no',
                        'options' => [
            ...
            case 'reminder_setting':
                $settings = array(
                    ...
                    array(
                        'name' => esc_html__( 'Email Content', 'ova-brw' ),
                        'type' => 'textarea',
                        'desc' => esc_html__( 'Use tags to generate email template. For example: You have hired a room: [ovabrw_vehicle_name] at [ovabrw_order_pickup_date]', 'ova-brw' ),
                        'default' => esc_html__( 'You have hired a room: [ovabrw_vehicle_name] at [ovabrw_order_pickup_date]', 'ova-brw' ),
