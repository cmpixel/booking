    ...
    class Ovabrw_Model {
        ...
        public function ovabrw_add_order_item( $order_id ) {
            ...
            foreach ( $order_items as $item_id => $product ) {
                ...
                $ovabrw_dropoff_date     = isset( $_POST['ovabrw_dropoff_date'][$i] )     ? sanitize_text_field( $_POST['ovabrw_dropoff_date'][$i] )   : "";
                ...
                if ( $ovabrw_rental_type === 'transportation' ) {
                    ...
                    $ovabrw_dropoff_date    = date( $ovabrw_date_time_format, $rental_info_period['end_time'] );
                ...
                if ( $defined_one_day == 'hotel' ) {
                    ...
                    $ovabrw_pickup_date_real        = date( $date_format, $ovabrw_pickup_date_timestamp ) . ' 00:00';
                    $ovabrw_dropoff_date_real       = date(  $date_format, ( $ovabrw_dropoff_date_timestamp - ( 3600 * 24 ) ) ) . ' 24:00';
                    ...
                    foreach ( $ovabrw_resources as $k => $rs_id ) {
                        ...
                        if ( ! is_bool( $rs_k ) ) {
                            if ( ovabrw_check_array( $resource_names, $rs_k ) ) {
                                array_push( $name_resources, $resource_names[$rs_k] );
                                $data_resources[$rs_id] = $resource_names[$rs_k];
                            }
                        }
                    }
