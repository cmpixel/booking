...
if ( ! class_exists( 'Ovabrw_Metabox' ) ) {
     class Ovabrw_Metabox{
        ...
        public function __construct(){
            ...
            add_action( 'cmb2_init', array( $this, 'ovabrw_custom_metaboxs_cmb2' ) );
        }
        ...
        public function ovabrw_save_fields_metabox( $post_id, $data ) {
            ...
            // Adult Number
            $ovabrw_adult     = isset($data['ovabrw_adult_number']) ? $data['ovabrw_adult_number'] : '';
            if ( ! empty( $ovabrw_adult ) ) {
                update_post_meta( $post_id, 'ovabrw_adult_number', $ovabrw_adult );
            } else {
                update_post_meta( $post_id, 'ovabrw_adult_number', 1 );
            }

            // Children Number
            $ovabrw_children  = isset($data['ovabrw_children_number']) ? $data['ovabrw_children_number'] : '';
            if ( ! empty( $ovabrw_children ) ) {
                update_post_meta( $post_id, 'ovabrw_children_number', $ovabrw_children );
            } else {
                update_post_meta( $post_id, 'ovabrw_children_number', 0 );
            }

            // Acreage
            $ovabrw_acreage   = isset($data['ovabrw_acreage_number']) ? $data['ovabrw_acreage_number'] : '';
            if ( ! empty( $ovabrw_acreage ) ) {
                update_post_meta( $post_id, 'ovabrw_acreage_number', $ovabrw_acreage );
            } else {
                update_post_meta( $post_id, 'ovabrw_acreage_number', 100 );
            }
          
            $ovabrw_acreage_unit = isset($data['ovabrw_acreage_unit']) ? $data['ovabrw_acreage_unit'] : '';
            if ( ! empty( $ovabrw_acreage_unit ) ) {
                update_post_meta( $post_id, 'ovabrw_acreage_unit', esc_attr( $ovabrw_acreage_unit) );
            } else {
                update_post_meta( $post_id, 'ovabrw_acreage_unit', 'ft' );
            }

            // Bed Number
            $ovabrw_bed = isset($data['ovabrw_bed_number']) ? $data['ovabrw_bed_number'] : '';
            if ( ! empty( $ovabrw_bed ) ) {
                update_post_meta( $post_id, 'ovabrw_bed_number', $ovabrw_bed );
            } else {
                update_post_meta( $post_id, 'ovabrw_bed_number', 1 );
            }

            // Bath Number
            $ovabrw_bath = isset($data['ovabrw_bath_number']) ? $data['ovabrw_bath_number'] : '';
            if ( ! empty( $ovabrw_bath ) ) {
                update_post_meta( $post_id, 'ovabrw_bath_number', $ovabrw_bath );
            } else {
                update_post_meta( $post_id, 'ovabrw_bath_number', 1 );
            }
            ...
            $ovabrw_show_dropoff_date_product = isset($data['ovabrw_show_dropoff_date_product']) ? $data['ovabrw_show_dropoff_date_product'] : '';
            update_post_meta( $post_id, 'ovabrw_show_dropoff_date_product', $ovabrw_show_dropoff_date_product );
        ...
        public function ovabrw_custom_metaboxs_cmb2() {
            ...
            $cmb2_settings = new_cmb2_box( array(
                ...
                'title'         => esc_html__( 'Rules & Regulations', 'ova-brw' ),
                ...
                $cmb2_settings->add_field( array(
                    'name' => esc_html__( 'Rules & Regulations', 'ova-brw' ),
                    'id'   => $prefix . 'room_rules',
                    'type'    => 'wysiwyg',
                    'options' => array(
                        'textarea_rows' => 30,
                    ),
