		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .wrap_calendar' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar' => 'align-items: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 	 	=> Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button-active' => 'background-color: {{VALUE}};',
				...
				$this->start_controls_tab(
		        	...
		        	$this->add_control(
			            ...
			            [
			                ...
			                'default' => '',
			                'selectors' => [
			                    '{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button' => 'color: {{VALUE}};',
			                ],
			            ]
			        );
			        ...
			        $this->add_control(
			            ...
			            [
			                ...
			                'default' => '',
			                'selectors' => [
			                    '{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button' => 'background-color: {{VALUE}};',
			                ],
			            ]
			        );
		        ...
		        $this->start_controls_tab(
		        	...
		        	$this->add_control(
			            ...
			            [
			                ...
			                'default' => '',
			                'selectors' => [
			                    '{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button:hover' => 'color: {{VALUE}};',
			                ],
			            ]
			        );
			        ...
			        $this->add_control(
			            ...
			            [
			                ...
			                'default' => '',
			                'selectors' => [
			                    '{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button:hover' => 'background-color: {{VALUE}};',
			                ],
			            ]
			        );
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar .fc-button-group .fc-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .wrap_calendar .fc-header-toolbar h2',
				]
			);
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-header-toolbar h2' => 'color: {{VALUE}};',
	                ],
	            ]
	        );
	        ...
	        $this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-header-toolbar h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-day-today' => 'background-color: {{VALUE}} !important;',
	                ],
	            ]
	        );
	        ...
	        $this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-day-past' => 'background-color: {{VALUE}} !important;',
	                ],
	            ]
	        );
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .wrap_calendar .fc-col-header-cell-cushion',
				]
			);
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-col-header-cell' => 'background-color: {{VALUE}};',
	                ],
	            ]
	        );
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-col-header-cell-cushion' => 'color: {{VALUE}};',
	                ],
	            ]
	        );
	        ...
	        $this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .wrap_calendar .fc-col-header-cell-cushion' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-daygrid-day' => 'background-color: {{VALUE}};',
	                ],
	            ]
	        );
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-daygrid-day-number' => 'color: {{VALUE}};',
	                ],
	            ]
	        );
	        ...
	        $this->add_control(
	            ...
	            [
	                ...
	                'default' => '',
	                'selectors' => [
	                    '{{WRAPPER}} .wrap_calendar .fc-daygrid-day-bg span' => 'color: {{VALUE}};',
	                ],
	            ]
	        );
