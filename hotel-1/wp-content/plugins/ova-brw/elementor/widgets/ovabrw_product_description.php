...
class ovabrw_product_description extends Widget_Base {

	public function get_name() {		
		return 'ovabrw_product_description';
	}

	public function get_title() {
		return esc_html__( 'Description', 'ova-brw' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ovabrw-product-details__description',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ovabrw-product-details__description' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', 'em', '%' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ovabrw-product-details__description' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
	...
	protected function render() {
		...
		<div class="elementor-description">
			<?php ovabrw_get_template( 'single/description.php', array( 'id' => $product_id ) ); ?>
		</div>
		<?php
	}
}