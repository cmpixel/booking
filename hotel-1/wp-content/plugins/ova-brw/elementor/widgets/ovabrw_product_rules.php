...
class ovabrw_product_rules extends Widget_Base {

	public function get_name() {		
		return 'ovabrw_product_rules';
	}

	public function get_title() {
		return esc_html__( 'Rules & Regulations', 'ova-brw' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ovabrw-product-rules',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ovabrw-product-rules' => 'color: {{VALUE}};',
					],
				]
			);
	...
	protected function render() {
		...
		?>
		<div class="elementor-product-rules">
			<?php ovabrw_get_template( 'single/rules.php', array( 'id' => $product_id ) ); ?>
		</div>
		<?php
	}
}