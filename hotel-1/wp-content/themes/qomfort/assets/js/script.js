(function($){
	...
	function qomfort_set_menu_direction($item) {
    ...
    function qomfort_hover_submenu() {
        $('.primary-navigation .menu-item-has-children').hover(function (event) {
            var $item = $(event.currentTarget);
            qomfort_set_menu_direction($item);
        });
    }
	...
	function qomfort_scrollUp(options) {
