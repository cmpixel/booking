(function($){
	...
	$(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/qomfort_elementor_video_2.default', function(){
	       
	        /* Add your code here */
	    	$('.ova-video-2').each( function() {
	        	var that = $(this);

	        	var video_active 	= that.find('.video_active');
	        	var modal_container = $('.ova-modal-container');
