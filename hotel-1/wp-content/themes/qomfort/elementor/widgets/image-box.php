...
class Qomfort_Elementor_Image_Box extends Widget_Base {

	public function get_name() {
		return 'qomfort_elementor_image_box';
	}

	public function get_title() {
		return esc_html__( 'Ova Image Box', 'qomfort' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content .content_inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content' => 'background: {{VALUE}}',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content_inner .icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content_inner .icon svg' => 'width: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}} .ova-image-box .content_inner .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-image-box .content_inner .icon i' => 'color: {{VALUE}}',
						'{{WRAPPER}} .ova-image-box .content_inner .icon svg' => 'fill: {{VALUE}}',
					],
				]
			);
			...
			$this->start_controls_tabs(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-image-box .content_inner .text_link' => 'color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-image-box .content_inner .text_link' => 'background: {{VALUE}}',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_group_control(
						\Elementor\Group_Control_Border::get_type(),
						[
							'name' => 'text_link_border_hover',
							'selector' => '{{WRAPPER}} .ova-image-box .content_inner .text_link:hover',
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-image-box .content_inner .text_link:hover' => 'color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-image-box .content_inner .text_link:hover' => 'background: {{VALUE}}',
							],
						]
					);
	...
	protected function render() {
		...
		?>
			<div class="ova-image-box">
				<?php if ( $image['url'] ): ?>
					<img src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image_alt ); ?>" class="img">
				<?php endif; ?>
				<div class="content">
...
$widgets_manager->register( new Qomfort_Elementor_Image_Box() );