...
class Qomfort_Elementor_Gallery_Slide extends Widget_Base {

	public function get_name() {
		return 'qomfort_elementor_gallery_slide';
	}

	public function get_title() {
		return esc_html__( 'Ova Gallery Slide', 'qomfort' );
	}
	...
	public function get_script_depends() {
		...
		return [ 'qomfort-elementor-gallery-slide' ];
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ova-gallery-slide .gallery-slide .gallery-box .list-gallery img' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-gallery-slide .gallery-slide .gallery-box .list-gallery .icon-box' => 'font-size: {{SIZE}}{{UNIT}};',
					],
				]
			);

			$this->add_responsive_control(
				'icon_box_background_size',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-gallery-slide .gallery-slide .gallery-box .list-gallery .icon-box' => 'width: {{SIZE}}{{UNIT}};min-width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-gallery-slide .gallery-slide .gallery-box .list-gallery .icon-box i' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-gallery-slide .gallery-slide .gallery-box .list-gallery .icon-box' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			<div class="ova-gallery-slide">
				...
				<div class="gallery-slide owl-carousel" data-options="<?php echo esc_attr(json_encode($data_options)); ?>" >
					...
					?>
						...
						<a href="#" data-fancybox="gallery-slide" data-src="<?php echo esc_url( $url ); ?>"
...
$widgets_manager->register( new Qomfort_Elementor_Gallery_Slide() );