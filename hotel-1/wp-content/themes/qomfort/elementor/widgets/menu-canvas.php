...
class Qomfort_Elementor_Canvas_Menu extends Widget_Base {

	public function get_name() {
		return 'qomfort_elementor_menu_canvas';
	}

	public function get_title() {
		return esc_html__( 'Menu Canvas', 'qomfort' );
	}
	...
	public function get_script_depends() {
		return [ 'qomfort-elementor-menu-canvas' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'btn_color',
				[
					'label' => esc_html__( 'Button', 'qomfort' ),
			...
			$this->add_control(
				'bg_color',
				[
					'label' => esc_html__( 'Menu Background', 'qomfort' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->add_control(
				'arrow_color',
				[
					'label' 	=> esc_html__( 'Arrow Color', 'qomfort' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
				'margin_submenu',
				[
					'label' 		=> esc_html__( 'Margin Sub', 'qomfort' ),
					'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' 	=> [ 'px', '%', 'em', 'custom' ],
					'selectors' 	=> [
...
$widgets_manager->register( new Qomfort_Elementor_Canvas_Menu() );