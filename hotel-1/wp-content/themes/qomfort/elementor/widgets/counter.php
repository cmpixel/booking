 ...
 * @since 1.0.0
 */
class Qomfort_Elementor_Counter extends Widget_Counter {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_counter',
			[
				'label' => esc_html__( 'Counter', 'qomfort' ),
			]
		);
		...
		$this->add_control(
			'starting_number',
			[
				'label' 	=> esc_html__( 'Starting Number', 'qomfort' ),
		...
		$this->add_control(
			'ending_number',
			[
				'label' 	=> esc_html__( 'Ending Number', 'qomfort' ),
				'type' 		=> Controls_Manager::NUMBER,
				'default' 	=> 100,
				'dynamic' 	=> [
					'active' => true,
		...
		$this->add_control(
			'prefix',
			[
				'label' 	=> esc_html__( 'Number Prefix', 'qomfort' ),
		...
		$this->add_control(
			'suffix',
			[
				'label' 	=> esc_html__( 'Number Suffix', 'qomfort' ),
				'type' 		=> Controls_Manager::TEXT,
				'dynamic' 	=> [
					'active' => true,
				],
		...
		$this->add_control(
			'behind',
			[
				'label' 	=> esc_html__( 'Number behind', 'qomfort' ),
				'type' 		=> Controls_Manager::TEXT,
				'dynamic' 	=> [
					'active' => false,
				],
				'default' 	=> '',
				'placeholder' => esc_html__( '01', 'qomfort' ),
			]
		);
		...
		$this->add_control(
			'duration',
			[
				'label' 	=> esc_html__( 'Animation Duration', 'qomfort' ),
				'type' 		=> Controls_Manager::NUMBER,
				'default' 	=> 2000,
				'min' 		=> 100,
				'step' 		=> 100,
		...
		$this->add_control(
			'thousand_separator',
			[
				'label' 	=> esc_html__( 'Thousand Separator', 'qomfort' ),
		...
		$this->add_control(
			...
			[
				...
				'default' 		=> esc_html__( 'Cool Number', 'qomfort' ),
				'placeholder' 	=> esc_html__( 'Cool Number', 'qomfort' ),
			]
		);
    	...
    	$this->add_control(
			'underline_style',
			[
				'label' 	=> esc_html__( 'Underline Style', 'qomfort' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' 	=> esc_html__( 'Behind', 'qomfort' ),
                'tab'   	=> Controls_Manager::TAB_STYLE,
                'condition' => [
                	'behind!' => '',
                ],
...
$widgets_manager->register(new Qomfort_Elementor_Counter());
