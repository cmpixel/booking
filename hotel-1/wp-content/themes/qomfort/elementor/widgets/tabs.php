 ...
 * @since 1.0.0
 */
class Qomfort_Elementor_Tabs extends Widget_Tabs {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'tab_icon_image',
            [
                'label' => esc_html__( 'Icon/Image', 'qomfort' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'qomfort' ),
                        'icon' => 'eicon-ban',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'qomfort' ),
                        'icon' => 'eicon-caret-right',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'qomfort' ),
                        'icon' => 'eicon-image',
                    ],
                ],
                'default'   => 'none',
        ...
        $repeater->add_control(
            'ova_icon',
            [
                'label'     => esc_html__( 'Choose Icon', 'qomfort' ),
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label' => esc_html__( 'Title & Description', 'qomfort' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Tab Title', 'qomfort' ),
                'placeholder' => esc_html__( 'Tab Title', 'qomfort' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'qomfort' ),
                'placeholder' => esc_html__( 'Tab Content', 'qomfort' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'qomfort' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'qomfort' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'qomfort' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'qomfort' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'qomfort' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'qomfort' ),
                    'vertical' => esc_html__( 'Vertical', 'qomfort' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '' => [
                        'title' => esc_html__( 'Start', 'qomfort' ),
                    ...
                    'stretch' => [
                        'title' => esc_html__( 'Justified', 'qomfort' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'navigation_width',
                [
                    'label' => esc_html__( 'Navigation Width', 'qomfort' ),
            ...
            $this->add_control(
                'border_width',
                [
                    'label' => esc_html__( 'Border Width', 'qomfort' ),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 1,
                    ],
            ...
            $this->add_control(
                'border_color',
                [
                    'label' => esc_html__( 'Border Color', 'qomfort' ),
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            'name'      => 'ova_title_typography_normal',
                            'selector'  => '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title, {{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'qomfort' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'qomfort' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        Group_Control_Typography::get_type(),
                        [
                            'name'      => 'ova_title_typography_active',
                            'selector'  => '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title.elementor-active, {{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title.elementor-active',
                        ]
                    );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Hover', 'qomfort' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'qomfort' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'qomfort' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
...
$widgets_manager->register(new Qomfort_Elementor_Tabs());