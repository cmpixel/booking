 ...
 * @since 1.0.0
 */
class Qomfort_Elementor_Toggle extends Widget_Toggle {
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Toggle', 'qomfort' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Title', 'qomfort' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Content', 'qomfort' ),
				'show_label' => false,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Toggle Items', 'qomfort' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Toggle #1', 'qomfort' ),
					...
					[
						'tab_title' => esc_html__( 'Toggle #2', 'qomfort' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'qomfort' ),
					],
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Icon', 'qomfort' ),
				'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'qomfort' ),
		...
		$this->add_control(
			'faq_schema',
			[
				'label' => esc_html__( 'FAQ Schema', 'qomfort' ),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__( 'Space Between', 'qomfort' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius Active', 'qomfort' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_control(
				'show_before_title',
				[
					'label' 	=> esc_html__( 'Show Before Title', 'qomfort' ),
            ...
            $this->add_control(
                'ova_before_title',
                [
                    'label'     => esc_html__( 'Before Title Style', 'qomfort' ),
		...
		$this->add_control(
			'icon_active_color',
			[
				'label' => esc_html__( 'Active Color', 'qomfort' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'ova_before_icon',
			[
				'label' 	=> esc_html__( 'Before Icon', 'qomfort' ),
	        ...
	        $this->add_control(
				'show_boxes_icon',
				[
					'label' 	=> esc_html__( 'Show Border Icon', 'qomfort' ),
					'type' 		=> \Elementor\Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'qomfort' ),
					'label_off' => esc_html__( 'Hide', 'qomfort' ),
					'default' 	=> 'no',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin (p, h1... h6)', 'qomfort' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
...
$widgets_manager->register(new Qomfort_Elementor_Toggle());
