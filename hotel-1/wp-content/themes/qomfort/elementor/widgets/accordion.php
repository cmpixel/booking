 ...
 * @since 1.0.0
 */
class Qomfort_Elementor_Accordion extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Accordion', 'qomfort' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => esc_html__( 'Accordion', 'qomfort' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accordion Title', 'qomfort' ),
				'dynamic' => [
					'active' => true,
				],
				'label_block' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accordion Content', 'qomfort' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Accordion Items', 'qomfort' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Accordion #1', 'qomfort' ),
					...
					[
						'tab_title' => esc_html__( 'Accordion #2', 'qomfort' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'qomfort' ),
					],
				],
			...
			foreach ( $settings['tabs'] as $index => $item ) :
				...
				<div class="elementor-accordion-item">
					<<?php Utils::print_validated_html_tag( $settings['title_html_tag'] ); ?> <?php $this->print_render_attribute_string( $tab_title_setting_key ); ?>>
						...
						<?php endif; ?>
						<a href="#" class="elementor-accordion-title" tabindex="0"><?php
				...
				_.each( settings.tabs, function( item, index ) {
					...
					<div class="elementor-accordion-item">
						<{{{ titleHTMLTag }}} {{{ view.getRenderAttributeString( tabTitleKey ) }}}>
							...
							<# } #>
							<a href="#" class="elementor-accordion-title" tabindex="0">{{{ item.tab_title }}}</a>
						</{{{ titleHTMLTag }}}>
...
$widgets_manager->register(new Qomfort_Elementor_Accordion());