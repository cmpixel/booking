...
if (!class_exists( 'Qomfort_Customize' )){

	class Qomfort_Customize {
		
		public function __construct() {
	        add_action( 'customize_register', array( $this, 'qomfort_customize_register' ) );
	    }

	    public function qomfort_customize_register($wp_customize) {
	        
	        $this->qomfort_init_remove_setting( $wp_customize );
	        $this->qomfort_init_ova_typography( $wp_customize );
	        $this->qomfort_init_ova_color( $wp_customize );
	        $this->qomfort_init_ova_layout( $wp_customize );
	        $this->qomfort_init_ova_header( $wp_customize );
	        $this->qomfort_init_ova_footer( $wp_customize );
	        $this->qomfort_init_ova_blog( $wp_customize );
	        
	        if( qomfort_is_woo_active() ){
	        	$this->qomfort_init_ova_woo( $wp_customize );	
	        }
	   
	        do_action( 'qomfort_customize_register', $wp_customize );
	    }

	    public function qomfort_init_remove_setting( $wp_customize ){
		    ...
		    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'logo', array(
		        'label'    => esc_html__( 'Logo Default', 'qomfort' ),
	    ...
	    /* Typo */
	    public function qomfort_init_ova_typography($wp_customize){

	    		/* Body Pane ******************************/
				$wp_customize->add_section( 'typo_general' , array(
				    'title'      => esc_html__( 'Typography', 'qomfort' ),
				    'priority'   => 1,
				    // 'panel' => 'typo_panel',
				) );
					...
					$wp_customize->add_control(
						new Qomfort_Customize_Control_Heading( 
						$wp_customize, 
						'text_typo_message', 
						array(
							'label'		=> esc_html__('Text Font','qomfort'),
						...
						$wp_customize->add_control('general_font_size', array(
							...
							'description' 	=> esc_html__('Example: 16px, 1.2em','qomfort'),
							'section' 		=> 'typo_general',
						...
						$wp_customize->add_control('general_line_height', array(
							'label' 		=> esc_html__('Line height','qomfort'),
							'description' 	=> esc_html__('Recommend use em. Example: 1.6em, 23px','qomfort'),
							'section' 		=> 'typo_general',
						...
						$wp_customize->add_control('general_letter_space', array(
							'label' 		=> esc_html__('Letter Spacing','qomfort'),
							'description' 	=> esc_html__('Example: 0px, 0.5em','qomfort'),
							'section' 		=> 'typo_general',
				...
				$wp_customize->add_control(
					...
					'general_heading', 
					array(
						'label' 	=> esc_html__('Primary Font','qomfort'),
			            'section' 	=> 'typo_general',
				...
				$wp_customize->add_setting( 'primary_font',
					array(
						'default' 			=> qomfort_default_primary_font(),
						'sanitize_callback' => 'qomfort_google_font_sanitization'
					)
				);
				
					$wp_customize->add_control( new Qomfort_Google_Font_Select_Custom_Control( $wp_customize, 'primary_font',
						array(
							'label' 			=> esc_html__( 'Primary Font', 'qomfort' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
				...
				$wp_customize->add_control(
					...
					'second_font_message', 
					array(
						'label' 	=> esc_html__('Second Font','qomfort'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_setting( 'second_font',
						array(
							'default' 			=> qomfort_default_second_font(),
							'sanitize_callback' => 'qomfort_google_font_sanitization'
						)
					);

					$wp_customize->add_control( new Qomfort_Google_Font_Select_Custom_Control( $wp_customize, 'second_font',
						array(
							'label' 			=> esc_html__( 'Font', 'qomfort' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
								'font_count' 	=> 'all',
								'orderby' 		=> 'popular',
				...
				$wp_customize->add_control(
					...
					'custom_font_message', 
					array(
						'label' 	=> esc_html__('Custom Font','qomfort'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_control('ova_custom_font', array(
						...
						'description' 	=> esc_html__('Step 1: Insert font-face in style.css file: Refer https://www.w3schools.com/cssref/css3_pr_font-face_rule.asp. Step 2: Insert font-family and font-weight like format: 
							["Perpetua", "Regular:Bold:Italic:Light"] | ["Name-Font", "Regular:Bold:Italic:Light"]. Step 3: Refresh customize page to display new font in dropdown font field.','qomfort'),
						'section' 		=> 'typo_general',
	     ...
	     /* Color */
	    public function qomfort_init_ova_color( $wp_customize ){

	    	/* Body Pane ******************************/
			$wp_customize->add_section( 'color_section' , array(
			    'title'      => esc_html__( 'Color', 'qomfort' ),
			    'priority'   => 2,
			    // 'panel' => 'typo_panel',
			) );
				...
				$wp_customize->add_setting( 'primary_color', array(
					...
					'theme_supports' 	=> '', // Rarely needed.
					'transport' 		=> 'refresh', // or postMessage
					'default'			=> qomfort_default_primary_color(),
					'sanitize_callback' => 'sanitize_text_field' // Get function name 
				) );
				...
				$wp_customize->add_control(
					...
					'primary_color', 
					array(
						'label' 	=> esc_html__("Primary",'qomfort'),
				...
				$wp_customize->add_control(
					...
					'primary_color_hover', 
					array(
						'label' 	=> esc_html__("Primary Hover",'qomfort'),
			            'section' 	=> 'color_section',
				...
				$wp_customize->add_control(
					...
					'heading_color', 
					array(
						'label' 	=> esc_html__("Heading",'qomfort'),
			            'section' 	=> 'color_section',
				...
				$wp_customize->add_control(
					...
					'light_color', 
					array(
						'label' 	=> esc_html__("Light",'qomfort'),
			            'section' 	=> 'color_section',
	    ...
	    /* Layout */
	    public function qomfort_init_ova_layout( $wp_customize ){

	    	$wp_customize->add_section( 'layout_section' , array(
			    'title'      => esc_html__( 'Layout', 'qomfort' ),
			    'priority'   => 2,
			) );
				...
				$wp_customize->add_control('global_boxed_container_width', array(
					'label' 	=> esc_html__('Container (px)','qomfort'),
				...
				$wp_customize->add_control('global_layout', array(
					...
					'type' 		=> 'select',
					'choices' 	=> apply_filters( 'qomfort_define_layout', array() )
				));
				...
				$wp_customize->add_control('global_sidebar_width', array(
					'label' 	=> esc_html__('Sidebar Width (px)','qomfort'),
					'section' 	=> 'layout_section',
				...
				$wp_customize->add_control('global_wide_site', array(
					'label' 	=> esc_html__('Wide Site','qomfort'),
					'section' 	=> 'layout_section',
					'settings' 	=> 'global_wide_site',
					'type' 		=> 'select',
					'choices' 	=> apply_filters( 'qomfort_define_wide_boxed', array() )
				));
				...
				$wp_customize->add_control('global_boxed_offset', array(
					'label' 	=> esc_html__('Boxed Offset (px)','qomfort'),
					'section' 	=> 'layout_section',
	    ...
	    /* Header */
	    public function qomfort_init_ova_header( $wp_customize ){

	    	$wp_customize->add_section( 'header_section' , array(
			    'title'      => esc_html__( 'Header', 'qomfort' ),
			    'priority'   => 3,
			) );
				...
				$wp_customize->add_control('global_header', array(
					'label' 		=> esc_html__('Header Default','qomfort'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'qomfort'),
					'section' 		=> 'header_section',
					'settings' 		=> 'global_header',
					'type' 			=> 'select',
					'choices' 		=> apply_filters( 'qomfort_list_header', array() )
				));
	    }

	    /* Footer */
	    public function qomfort_init_ova_footer( $wp_customize ){

	    	$wp_customize->add_section( 'footer_section' , array(
			    'title'      => esc_html__( 'Footer', 'qomfort' ),
			    'priority'   => 4,
			) );
				...
				$wp_customize->add_control('global_footer', array(
					'label' 		=> esc_html__('Footer Default','qomfort'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'qomfort'),
					'section' 		=> 'footer_section',
					'settings' 		=> 'global_footer',
					'type' 			=> 'select',
					'choices' 		=> apply_filters( 'qomfort_list_footer', array() )
				));
	    }


	    /* Blog */
	    public function qomfort_init_ova_blog( $wp_customize ){

	    	$wp_customize->add_panel( 'blog_panel', array(
			    'title'		=> esc_html__( 'Blog', 'qomfort' ),
			    'priority' 	=> 5,
			) );

				$wp_customize->add_section( 'blog_section' , array(
				    'title' 	=> esc_html__( 'Archive', 'qomfort' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );
					...
					$wp_customize->add_control('blog_template', array(
						...
						'type' 		=>'select',
						'choices' 	=> array(
							'default' 	=> esc_html__('Default', 'qomfort'),
							'grid'		=> esc_html__('Grid', 'qomfort'),
							'masonry' 	=> esc_html__('Masonry', 'qomfort'),
						)
					));
					...
					$wp_customize->add_control('blog_archive_show_media', array(
						'label' 	=> esc_html__('Show Media','qomfort'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_archive_show_comment', array(
						'label' 	=> esc_html__('Show Comment','qomfort'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_archive_show_excerpt', array(
						'label' 	=> esc_html__('Show Excerpt','qomfort'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_header', array(
						'label' 	=> esc_html__('Header','qomfort'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_footer', array(
						'label' 	=> esc_html__('Footer','qomfort'),
						'section' 	=> 'blog_section',
				...
				$wp_customize->add_section( 'single_section' , array(
				    'title' 	=> esc_html__( 'Single', 'qomfort' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );	
					...
					$wp_customize->add_control('blog_single_show_tag', array(
						'label' 	=> esc_html__('Show Tag','qomfort'),
						'section' 	=> 'single_section',
					...
					$wp_customize->add_control('blog_single_show_share_social_icon', array(
						'label' => esc_html__('Show Share Social Icon','qomfort'),
						'section' => 'single_section',
					...
					$wp_customize->add_control('blog_single_show_next_prev_post', array(
						'label' => esc_html__('Show Next Prev','qomfort'),
						'section' => 'single_section',
	    ...
	    public function qomfort_init_ova_woo( $wp_customize ){
			...
			$wp_customize->add_control('woo_archive_display', array(
				'label'    => esc_html__('Shop products display','qomfort'),
				'section'  => 'woocommerce_product_catalog',
				'settings' => 'woo_archive_display',
				'type'     =>'select',
				'choices'  => array(
					'all' => esc_html__('All products', 'qomfort'),
					'ovabrw_car_rental' => esc_html__('Rental products', 'qomfort'),
					'not_rental' => esc_html__('Not Rental products', 'qomfort'),
				)
			));
			...
			$wp_customize->add_control('woo_archive_layout', array(
				'label'    => esc_html__('Archive Layout','qomfort'),
				'section'  => 'woocommerce_product_catalog',
				'settings' => 'woo_archive_layout',
				'type'     =>'select',
				'choices'  => array(
					'woo_layout_1c' => esc_html__('No Sidebar', 'qomfort'),
					'woo_layout_2r' => esc_html__('Right Sidebar', 'qomfort'),
					'woo_layout_2l' => esc_html__('Left Sidebar', 'qomfort'),
				)
			));
	    	...
	    	$wp_customize->add_control('woo_archive_show_title', array(
	    		'label'    	=> esc_html__('Show/Hide Title','qomfort'),
	    		'section'  	=> 'woocommerce_product_catalog',
			...
			$wp_customize->add_section( 'product_detail' , array(
			    'title' 	=> esc_html__( 'Product detail', 'qomfort' ),
			    'priority' 	=> 30,
			    'panel' 	=> 'woocommerce',
			) );
			...
			$wp_customize->add_control('woo_product_layout', array(
				'label'    => esc_html__('Single Layout','qomfort'),
			...
			$wp_customize->add_control('woo_single_header', array(
				...
				'type' 		=>'select',
				'choices' 	=> apply_filters('qomfort_list_header', '')
			));
			...
			$wp_customize->add_control('woo_single_footer', array(
				...
				'type' 		=>'select',
				'choices' 	=> apply_filters('qomfort_list_footer', '')
			));
