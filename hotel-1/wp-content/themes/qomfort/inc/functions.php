...
if( !function_exists( 'qomfort_get_current_id' )):
	function qomfort_get_current_id(){
...
if (!function_exists('qomfort_is_elementor_active')) {
    function qomfort_is_elementor_active(){
        return did_action( 'elementor/loaded' );
    }
}

if (!function_exists('qomfort_is_woo_active')) {
    function qomfort_is_woo_active(){
        return class_exists('woocommerce');    
    }
}

if (!function_exists('qomfort_is_blog_archive')) {
    function qomfort_is_blog_archive() {
...
function qomfort_get_id_by_slug( $page_slug ) {
...
function qomfort_custom_text ($content = "",$limit = 15) {
 ...
 */
if ( ! function_exists( 'qomfort_google_font_sanitization' ) ) {
    function qomfort_google_font_sanitization( $input ) {
...
if ( ! function_exists( 'qomfort_default_primary_color' ) ) {
    function qomfort_default_primary_color() {
        $primary_color = get_theme_mod( 'primary_color', '#AB6034' );
...
if ( ! function_exists( 'qomfort_default_primary_font' ) ) {
    function qomfort_default_primary_font() {
        $customizer_defaults = json_encode(
            array(
                'font' => 'Roboto',
                'regularweight' => '100,100italic,300,300italic,regular,italic,500,500italic,700,700italic,900,900italic',
                'category' => 'serif'
            )
        );
...
if ( ! function_exists( 'qomfort_default_second_font' ) ) {
    function qomfort_default_second_font() {
        $customizer_defaults = json_encode(
            array(
                'font' => 'Cormorant Garamond',
                'regularweight' => '300,300italic,regular,italic,500,500italic,600,600italic,700,700italic',
                'category' => 'serif'
            )
        );
...
if ( ! function_exists( 'qomfort_woo_sidebar' ) ) {
    function qomfort_woo_sidebar(){
...
if( !function_exists( 'qomfort_blog_show_readmore' ) ){
    function qomfort_blog_show_readmore(){
...
if( !function_exists( 'qomfort_post_show_media' ) ){
    function qomfort_post_show_media(){
        $show_media = get_theme_mod( 'blog_single_show_media', 'yes' );
        return isset( $_GET['show_media'] ) ? $_GET['show_media'] : $show_media;
    }
}

if( !function_exists( 'qomfort_post_show_title' ) ){
    function qomfort_post_show_title(){
        $show_title = get_theme_mod( 'blog_single_show_title', 'yes' );
        return isset( $_GET['show_title'] ) ? $_GET['show_title'] : $show_title;
    }
}

if( !function_exists( 'qomfort_post_show_date' ) ){
    function qomfort_post_show_date(){
        $show_date = get_theme_mod( 'blog_single_show_date', 'yes' );
        return isset( $_GET['show_date'] ) ? $_GET['show_date'] : $show_date;
    }
}

if( !function_exists( 'qomfort_post_show_cat' ) ){
    function qomfort_post_show_cat(){
        $show_cat = get_theme_mod( 'blog_single_show_cat', 'yes' );
        return isset( $_GET['show_cat'] ) ? $_GET['show_cat'] : $show_cat;
    }
}

if( !function_exists( 'qomfort_post_show_author' ) ){
    function qomfort_post_show_author(){
        $show_author = get_theme_mod( 'blog_single_show_author', 'yes' );
        return isset( $_GET['show_author'] ) ? $_GET['show_author'] : $show_author;
    }
}

if( !function_exists( 'qomfort_post_show_comment' ) ){
    function qomfort_post_show_comment(){
        $show_comment = get_theme_mod( 'blog_single_show_comment', 'yes' );
        return isset( $_GET['show_comment'] ) ? $_GET['show_comment'] : $show_comment;
    }
}

if( !function_exists( 'qomfort_post_show_tag' ) ){
    function qomfort_post_show_tag(){
        $show_tag = get_theme_mod( 'blog_single_show_tag', 'yes' );
        return isset( $_GET['show_tag'] ) ? $_GET['show_tag'] : $show_tag;
    }
}

if( !function_exists( 'qomfort_post_show_share_social_icon' ) ){
    function qomfort_post_show_share_social_icon(){
...
if( !function_exists( 'qomfort_post_show_next_prev_post' ) ){
    function qomfort_post_show_next_prev_post(){
